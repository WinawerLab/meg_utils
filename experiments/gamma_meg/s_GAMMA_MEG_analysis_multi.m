...
which_data_sets_to_analyze    = [4:11 13:15];   % subject 99 for synthetic data
...
for subject_num = which_data_sets_to_analyze
    ...
    %% Save Processed Data
    filename = fullfile(project_pth, subj_pths{subject_num}, 'processed', sprintf('s0%d_localregression_multi.mat',subject_num+1));
