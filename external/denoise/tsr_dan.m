function [y,idx,w]=tsr_dan(x,ref,shifts,wx,wref,keep,thresh)
%[y,idx,w]=tsr(x,ref,shifts,wx,wref,keep,thresh) - time-shift regression (TSPCA)
%
%  y: denoised data 
...
% Insert something here to grab the value of x at the points where w == 0
% and then
...
[cref,twcref]=tscov_dan(ref,shifts,wref);
...
[y,mn2]=demean(y,wx);    % multishift(ref) is not necessarily 0 mean
