function output = checkForDeadChannels(sqdFile)
...
%     disp(['blockNumber is ', num2str(thisBlock)]);
    ...
    findClips(data,thisBlockMin, thisBlockMax,sampleRate);
...
function findClips(data,thisBlockMin, thisBlockMax, sampleRate)
