function [t, ts, num_epoch_time_pts,epochs_on,epochs_off,epochs_condition] = ...
    ssmeg_fix_triggers(ts, experiment_name, produce_figures)
...
clear triggerBinary; 
clear data_trig1; clear data_trig2; clear data_trig3;


%% Remove values 3,4 for blanks
...
if produce_figures
    ...
    weird = find(trigger == 4 | trigger == 6);
    set(gca, 'XTick', weird, 'XGrid', 'on');
    title('Trigger channels (indices and values)');
    xlabel('Time [s]');
    ylabel('Relative amplitude');
    legend('Trigger 1 / Chan 161', 'Trigger 2 / Chan 162', 'Trigger 3 / Chan 163');
...
%% Fix triggers when they have value 4 or 6 
% 
