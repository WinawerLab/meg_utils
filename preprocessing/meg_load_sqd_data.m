function [ts, meg_files] = meg_load_sqd_data(data_pth, fname_str)
% This function loads the SQD MEG files and concatenates them, if there is
% more than one.
%
...
meg_files = dir(fullfile(data_pth, sprintf('%s.sqd', fname_str)));
